export default [
  ...
  },
  {
    login: 'oualter',
    id: 31335,
    node_id: 'MDQ6VXNlcjMxMzM1',
    avatar_url: 'https://avatars.githubusercontent.com/u/31335?v=4',
    gravatar_id: '',
    url: 'https://api.github.com/users/oualter',
    html_url: 'https://github.com/oualter',
    followers_url: 'https://api.github.com/users/oualter/followers',
    following_url:
      'https://api.github.com/users/oualter/following{/other_user}',
    gists_url: 'https://api.github.com/users/oualter/gists{/gist_id}',
    starred_url: 'https://api.github.com/users/oualter/starred{/owner}{/repo}',
    subscriptions_url: 'https://api.github.com/users/oualter/subscriptions',
    organizations_url: 'https://api.github.com/users/oualter/orgs',
    repos_url: 'https://api.github.com/users/oualter/repos',
    events_url: 'https://api.github.com/users/oualter/events{/privacy}',
    received_events_url: 'https://api.github.com/users/oualter/received_events',
    type: 'User',
    site_admin: false,
  },
  {
  ...
  },
  {
    login: 'robertozoia',
    id: 59854,
    node_id: 'MDQ6VXNlcjU5ODU0',
    avatar_url: 'https://avatars.githubusercontent.com/u/59854?v=4',
    gravatar_id: '',
    url: 'https://api.github.com/users/robertozoia',
    html_url: 'https://github.com/robertozoia',
    followers_url: 'https://api.github.com/users/robertozoia/followers',
    following_url:
      'https://api.github.com/users/robertozoia/following{/other_user}',
    gists_url: 'https://api.github.com/users/robertozoia/gists{/gist_id}',
    starred_url:
      'https://api.github.com/users/robertozoia/starred{/owner}{/repo}',
    subscriptions_url: 'https://api.github.com/users/robertozoia/subscriptions',
    organizations_url: 'https://api.github.com/users/robertozoia/orgs',
    repos_url: 'https://api.github.com/users/robertozoia/repos',
    events_url: 'https://api.github.com/users/robertozoia/events{/privacy}',
    received_events_url:
      'https://api.github.com/users/robertozoia/received_events',
    type: 'User',
    site_admin: false,
  },
  {
  ...
  {
    login: 'rajeshodayanchal',
    id: 135743,
    node_id: 'MDQ6VXNlcjEzNTc0Mw==',
    avatar_url: 'https://avatars.githubusercontent.com/u/135743?v=4',
    gravatar_id: '',
    url: 'https://api.github.com/users/rajeshodayanchal',
    html_url: 'https://github.com/rajeshodayanchal',
    followers_url: 'https://api.github.com/users/rajeshodayanchal/followers',
    following_url:
      'https://api.github.com/users/rajeshodayanchal/following{/other_user}',
    gists_url: 'https://api.github.com/users/rajeshodayanchal/gists{/gist_id}',
    starred_url:
      'https://api.github.com/users/rajeshodayanchal/starred{/owner}{/repo}',
    subscriptions_url:
      'https://api.github.com/users/rajeshodayanchal/subscriptions',
    organizations_url: 'https://api.github.com/users/rajeshodayanchal/orgs',
    repos_url: 'https://api.github.com/users/rajeshodayanchal/repos',
    events_url:
      'https://api.github.com/users/rajeshodayanchal/events{/privacy}',
    received_events_url:
      'https://api.github.com/users/rajeshodayanchal/received_events',
    type: 'User',
    site_admin: false,
  },
  {
